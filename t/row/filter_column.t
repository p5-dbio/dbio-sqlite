...
DBIO::Test::Schema::Artist->load_components(qw(FilterColumn InflateColumn));
...
IC_DIE: {
  throws_ok {
     DBIO::Test::Schema::Artist->inflate_column(charfield =>
  ...
  DBIO::Test::Schema::Artist->inflate_column(name =>
     { inflate => sub {}, deflate => sub {} }
  );

  throws_ok {
     DBIO::Test::Schema::Artist->filter_column(name => {
...
throws_ok { DBIO::Test::Schema::Artist->filter_column( charfield => {} ) }
...
FC_ON_PK_TEST: {
  ...
  DBIO::Test::Schema::Artist->filter_column(artistid => {
