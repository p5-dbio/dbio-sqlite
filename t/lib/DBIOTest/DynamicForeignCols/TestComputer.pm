package DBIOTest::DynamicForeignCols::TestComputer;
...
__PACKAGE__->_add_join_column({ class => 'DBIOTest::DynamicForeignCols::Computer', method => 'computer' });
__PACKAGE__->set_primary_key('test_id', 'computer_id');
__PACKAGE__->belongs_to(computer => 'DBIOTest::DynamicForeignCols::Computer', 'computer_id');
