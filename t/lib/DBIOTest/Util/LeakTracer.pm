package DBIOTest::Util::LeakTracer;
...
use DBIOTest::Util qw( stacktrace visit_namespaces );
use constant {
  CV_TRACING => !DBIOTest::RunMode->is_plain && DBIO::Optional::Dependencies->req_ok_for ('test_leaks_heavy'),
