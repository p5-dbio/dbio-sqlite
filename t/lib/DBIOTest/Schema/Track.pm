...
__PACKAGE__->belongs_to( cd => 'DBIOTest::Schema::CD', undef, {
    proxy => { cd_title => 'title' },
});
# custom condition coderef
__PACKAGE__->belongs_to( cd_cref_cond => 'DBIOTest::Schema::CD',
sub {
...
__PACKAGE__->belongs_to( disc => 'DBIOTest::Schema::CD' => 'cd', {
    proxy => 'year'
});

__PACKAGE__->might_have( cd_single => 'DBIOTest::Schema::CD', 'single_track' );
__PACKAGE__->might_have( lyrics => 'DBIOTest::Schema::Lyrics', 'track_id' );

__PACKAGE__->belongs_to(
    "year1999cd",
    "DBIOTest::Schema::Year1999CDs",
    'cd',
    { join_type => 'left' },  # the relationship is of course optional
);
__PACKAGE__->belongs_to(
    "year2000cd",
    "DBIOTest::Schema::Year2000CDs",
    'cd',
    { join_type => 'left' },
);
