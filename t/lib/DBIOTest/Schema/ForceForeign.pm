...
__PACKAGE__->might_have('artist_1', 'DBIOTest::Schema::Artist', 'artistid',
  { is_foreign_key_constraint => 1 },
);

# Normally this would appear as a FK constraint
__PACKAGE__->might_have('cd_1', 'DBIOTest::Schema::CD',
  { 'foreign.cdid' => 'self.cd' },
  { is_foreign_key_constraint => 0 },
);

# Normally this would appear as a FK constraint
__PACKAGE__->belongs_to('cd_3', 'DBIOTest::Schema::CD',
  { 'foreign.cdid' => 'self.cd' },
  { is_foreign_key_constraint => 0 },
);
