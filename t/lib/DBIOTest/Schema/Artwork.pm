...
__PACKAGE__->belongs_to('cd', 'DBIOTest::Schema::CD', 'cd_id');
__PACKAGE__->has_many('images', 'DBIOTest::Schema::Image', 'artwork_id');

__PACKAGE__->has_many('artwork_to_artist', 'DBIOTest::Schema::Artwork_to_Artist', 'artwork_cd_id');
...
__PACKAGE__->has_many('artwork_to_artist_test_m2m', 'DBIOTest::Schema::Artwork_to_Artist',
  sub {
