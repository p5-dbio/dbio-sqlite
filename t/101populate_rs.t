...
SCHEMA_POPULATE1: {
  ...
  isa_ok  $artist1, 'DBIO::Test::Artist';
  isa_ok  $artist2, 'DBIO::Test::Artist';
  isa_ok  $artist3, 'DBIO::Test::Artist';
  isa_ok  $undef, 'DBIO::Test::Artist';
  ...
  ARTIST1CDS: {
    ...
    isa_ok $cd1, 'DBIO::Test::CD';
    isa_ok $cd2, 'DBIO::Test::CD';
    isa_ok $cd3, 'DBIO::Test::CD';
...
ARRAY_CONTEXT: {
  ...
  HAS_MANY_NO_PKS: {
    ...
    isa_ok( $crap, 'DBIO::Test::Artist', "Got 'Artist'");
    isa_ok( $girl, 'DBIO::Test::Artist', "Got 'Artist'");
    isa_ok( $damn, 'DBIO::Test::Artist', "Got 'Artist'");
    isa_ok( $formerly, 'DBIO::Test::Artist', "Got 'Artist'");
  ...
  BELONGS_TO_NO_PKs: {
    ...
    isa_ok($cdA, 'DBIO::Test::CD', 'Created CD');
    isa_ok($cdA->artist, 'DBIO::Test::Artist', 'Set Artist');
    is($cdA->artist->name, 'Fred BloggsC', 'Set Artist to FredC');


    isa_ok($cdB, 'DBIO::Test::CD', 'Created CD');
    isa_ok($cdB->artist, 'DBIO::Test::Artist', 'Set Artist');
...
VOID_CONTEXT: {
  ...
  HAS_MANY_WITH_PKS: {
    ...
    isa_ok( $damn, 'DBIO::Test::Artist', "Got 'Artist'");
    isa_ok( $formerly, 'DBIO::Test::Artist', "Got 'Artist'");
    isa_ok( $undef, 'DBIO::Test::Artist', "Got 'Artist'");
  ...
  BELONGS_TO_NO_PKs: {
    ...
    isa_ok($cdC, 'DBIO::Test::CD', 'Created CD');
    isa_ok($cdC->artist, 'DBIO::Test::Artist', 'Set Artist');
