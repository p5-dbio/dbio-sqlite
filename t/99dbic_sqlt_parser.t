...
lives_ok { isa_ok (create_schema ({ schema => 'DBIO::Test::Schema' }), 'SQL::Translator::Schema', 'SQLT schema object produced') };
...
SKIP: {
  ...
  lives_ok {
    ...
    my $s = DBIO::SQLite::Test->init_schema(no_populate => 1);
...
{
    {
        package # hide from PAUSE
            DBIO::Test::Schema::NoViewDefinition;
    ...
    $schema_invalid_view->register_class('NoViewDefinition', 'DBIO::Test::Schema::NoViewDefinition');
...
{
  package DBIO::Test::PartialSchema;
...
{
  my $partial_schema = DBIO::Test::PartialSchema->connect(DBIO::SQLite::Test->_database);
