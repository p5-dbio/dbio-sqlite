...
{
  package DBIO::Test::SQLMaker::CustomDialect;
...
my $s = DBIO::Test::Schema->connect (DBIO::SQLite::Test->_database);
$s->storage->sql_maker_class ('DBIO::Test::SQLMaker::CustomDialect');
